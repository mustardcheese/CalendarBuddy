...
class DocumentUploadForm(forms.ModelForm):
    ...
    def __init__(self, user=None, *args, **kwargs):
        ...
        if user:
            ...
            self.fields['task'].queryset = Task.objects.filter(user=user).order_by('-date')
    ...
    def clean_file(self):
        ...
        if file:
            ...
            if file.size > max_size:
                raise forms.ValidationError(f'File size must be less than 10MB. Your file is {file.size / (1024*1024):.1f}MB.')
